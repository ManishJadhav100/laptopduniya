...
VAPID_CLAIMS = {
    "sub": "mailto:admin@laptopduniya.in"
}
...
def send_price_drop_notification(subscription, current_price, store_name):
    ...
    payload = {
        ...
        "body": f"The {laptop_title} just dropped to ₹{current_price} at {store_name}! View the deal now.",
        "url": f"https://laptopduniya.in/laptops/{subscription.laptop.slug}",
...
def broadcast_to_topic(topic, title, message, url="/"):
    ...
    payload = {
        "title": title,
        "body": message,
        "url": f"https://laptopduniya.in{url}",
        "icon": "https://cdn-icons-png.flaticon.com/512/428/428001.png"
    }
