    ...
    <div className="bg-white py-24">
      <div className="max-w-[800px] mx-auto px-4">
        ...
        <div className="prose prose-emerald lg:prose-xl max-w-none text-gray-600 font-bold leading-relaxed space-y-8">
          <p>Transparency is the cornerstone of <strong>PhoneRadar</strong>. We want you to understand how we keep the lights on while providing free, high-quality content and tools.</p>
          ...
          <div className="bg-[#10B981] bg-opacity-5 p-10 rounded-[2.5rem] border border-[#10B981] border-opacity-10 relative overflow-hidden">
             ...
             <p className="mb-0">PhoneRadar is a participant in the amazon services LLC associates program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to amazon.com, amazon.in, and other regional Amazon stores, as well as Flipkart.com.</p>
          </div>
          ...
          <ul className="space-y-4 list-none p-0">
             <li className="flex gap-4"><CheckCircle2 className="text-[#10B981] shrink-0" size={24} /> <span><strong>Independence:</strong> Commissions never influence our editorial ratings. If a phone is bad, we'll say so.</span></li>
          ...
          <div className="pt-12 border-t border-gray-100">
             <p className="text-sm italic">If you have any questions about our affiliate partnerships, please reach out to <strong>hello@phoneradar.in</strong>.</p>
          </div>
        </div>
      </div>
    </div>
