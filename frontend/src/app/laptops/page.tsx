...
async function getLaptops(searchParams: any) {
  ...
  return fetchApiList<any>(`/laptops/${query ? `?${query}` : ""}`, {
    next: { revalidate: 300 },
...
export const metadata = {
  title: "All Laptop Deals & Models - Laptop Duniya",
  description: "Browse the complete catalog of laptops with latest pricing and deals.",
};
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
           <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-2">
                 ...
                 <span className="text-[#10B981]">All Laptops</span>
              </div>
              <h1 className="text-[22px] font-black text-gray-900 tracking-tight">Browse All Laptop Deals</h1>
              <p className="text-gray-500 font-bold text-sm max-w-xl">Explore our hand-picked catalog of the latest laptops from global brands, verified for quality and value.</p>
           </div>
          ...
          <div className="lg:col-span-9">
            {laptops.length > 0 ? (
                ...
                <div className="bg-white border border-gray-100 rounded-3xl p-20 text-center flex flex-col items-center">
                    ...
                    <h2 className="text-xl font-black text-gray-900 mb-2">No laptops match your selection</h2>
                    <p className="text-gray-500 font-bold mb-8">Try adjusting your price range or selecting different hardware options.</p>
                    
                    {activeFilterCount > 0 && (
                        <Link href="/laptops" className="inline-flex items-center gap-2 bg-[#10B981] text-white px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest shadow-lg hover:bg-[#059669] transition-all">
